...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PAW & CO. — Practical products for dogs and cats" },
      {
        name: "description",
        content:
          "PAW & CO. is a UK pet brand offering carefully selected, practical products for dogs and cats. Secure checkout, prices in GBP.",
      },
      { property: "og:site_name", content: "PAW & CO." },
